...
export default function LaserCutting() {
  ...
  const applications = [
    ...
    { name: "Automotive Parts", desc: "Lightweight, high-strength chassis and engine components meeting strict automotive tolerances.", image: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&q=80&w=800", span: "md:col-span-1 md:row-span-2" },
  ...
  return (
    <main className="pt-20 bg-[#F8FAFC] text-gray-900 selection:bg-[#003554] selection:text-white">
      {/* 1. HERO SECTION */}
      <HeroSlider 
      ...
      <section className="py-24 px-8 md:px-12 bg-white relative overflow-hidden">
        <div className="max-w-[96%] 2xl:max-w-[1920px] mx-auto relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#003554] font-headline-xl leading-[1.1] mb-6">What We Offer</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {offerings.map((item, idx) => (
              <motion.div 
                ...
                className="bg-[#F8FAFC] border border-gray-100 rounded-2xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
              >
                <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center shadow-sm mb-6 text-[#00A6FB]">
                  <item.icon className="w-7 h-7" />
                </div>
                <h3 className="text-xl font-bold text-[#003554] mb-3">{item.title}</h3>
      ...
      <section className="py-32 px-8 md:px-12 bg-[#00101A] text-white relative overflow-hidden">
        {/* Abstract animated background */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#00A6FB]/5 blur-[120px] rounded-full pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-[#003554]/20 blur-[150px] rounded-full pointer-events-none"></div>
        </div>

        <div className="max-w-[96%] 2xl:max-w-[1920px] mx-auto relative z-10">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-headline-xl mb-6">Laser Cutting <span className="text-[#00A6FB]">Process</span></h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">Our streamlined laser cutting process ensures precision, consistency, and efficiency at every single stage of production.</p>
            <div className="w-20 h-1 bg-[#00A6FB] mx-auto rounded-full mt-8"></div>
          </div>
          ...
          <div className="flex flex-col gap-24 md:gap-32">
            {processSteps.map((step, idx) => {
              ...
              return (
                <div key={idx} className={`flex flex-col ${isEven ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12 lg:gap-24 relative`}>
                  <div className={`hidden lg:block absolute top-1/2 -translate-y-1/2 ${isEven ? 'left-0 -translate-x-1/4' : 'right-0 translate-x-1/4'} text-[300px] font-black text-white/[0.02] leading-none pointer-events-none z-0`}>
                    0{idx + 1}
                  </div>
                  <motion.div 
                    ...
                    className="w-full md:w-1/2 relative z-10 group"
                  >
                    <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-[0_20px_50px_-15px_rgba(0,166,251,0.2)] border border-white/5 bg-[#00253B]">
                      <img 
                        src={step.image} 
                        alt={step.title} 
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#00101A] via-[#00101A]/40 to-transparent opacity-80 group-hover:opacity-40 transition-opacity duration-700"></div>
                      <div className="absolute bottom-6 right-6 w-16 h-16 bg-[#00A6FB] text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg border-2 border-[#00101A] transform group-hover:-translate-y-2 transition-transform duration-500">
                        0{idx + 1}
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shadow-lg backdrop-blur-sm">
                        <step.icon className="w-8 h-8 text-[#00A6FB]" />
                      </div>
                      <div className="h-[2px] w-12 bg-gradient-to-r from-[#00A6FB] to-transparent"></div>
                    </div>
                    ...
                    {idx < processSteps.length - 1 && (
                      <div className="md:hidden w-[2px] h-24 bg-gradient-to-b from-[#00A6FB]/40 to-transparent mt-12 mx-auto"></div>
                    )}
                  </motion.div>
                </div>
              );
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden">
        <div className="max-w-[96%] 2xl:max-w-[1920px] mx-auto px-6 md:px-12 w-full mb-16 relative z-10">
              ...
              {[...materials, ...materials].map((mat, idx) => (
                ...
                >
                  <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#00101A] via-[#00101A]/50 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500"></div>
                    
                    <div className="absolute top-6 right-6 w-10 h-10 bg-[#00A6FB] rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-6 h-auto md:h-[900px]">
            {applications.map((app, idx) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#00101A] via-[#00101A]/40 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500"></div>
      ...
      <section className="py-24 md:py-32 bg-[#00253B] text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#00253B] via-[#00253B]/90 to-transparent pointer-events-none"></div>

        <div className="max-w-[96%] 2xl:max-w-[1920px] mx-auto relative z-10 px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center justify-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {["CNC-Controlled Laser Systems", "High-Speed Metal Cutting", "Precision Dimensional Control", "Complex Profile Cutting", "Efficient Material Utilization", "Consistent Production Quality"].map((item, idx) => (
                <div key={idx} className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors backdrop-blur-sm">
                  <div className="w-10 h-10 rounded-xl bg-[#00A6FB]/20 flex items-center justify-center mb-4">
      ...
      <section className="py-24 md:py-32 bg-[#F8FAFC]">
        <div className="max-w-[96%] 2xl:max-w-[1920px] mx-auto px-6 md:px-12">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#003554] font-headline-xl mb-6">Our Commitment to <span className="text-[#00A6FB]">Precision</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {["Accurate Dimensions", "Superior Edge Finish", "Reliable Performance", "Process Consistency", "Customer Satisfaction", "Continuous Improvement"].map((item, idx) => (
              <div key={idx} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-6 relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-[#F8FAFC] text-[#00A6FB] flex items-center justify-center shrink-0 border border-gray-100 group-hover:bg-[#00A6FB] group-hover:text-white transition-colors duration-300">
                    <Target className="w-8 h-8" />
                  </div>
                  <h3 className="text-xl font-bold text-[#003554]">{item}</h3>
                </div>
              </div>
            ))}
          </div>
